...
class TestWaitConditions(unittest.TestCase):
    ...
    def test_exponential(self):
        ...
        self.assertLessEqual(r.wait(1, 0), 2)
        self.assertLessEqual(r.wait(2, 0), 4)
        self.assertLessEqual(r.wait(3, 0), 8)
        self.assertLessEqual(r.wait(4, 0), 16)
        self.assertLessEqual(r.wait(5, 0), 32)
        self.assertLessEqual(r.wait(6, 0), 64)
    ...
    def test_exponential_with_max_wait(self):
        ...
        self.assertLessEqual(r.wait(4, 0), 16)
        self.assertLessEqual(r.wait(5, 0), 32)
        self.assertLessEqual(r.wait(6, 0), 40)
        self.assertLessEqual(r.wait(7, 0), 40)
        self.assertLessEqual(r.wait(50, 0), 40)
    ...
    def test_exponential_with_max_wait_and_multiplier(self):
        ...
        self.assertLessEqual(r.wait(1, 0), 2000)
        self.assertLessEqual(r.wait(2, 0), 4000)
        self.assertLessEqual(r.wait(3, 0), 8000)
        self.assertLessEqual(r.wait(4, 0), 16000)
        self.assertLessEqual(r.wait(5, 0), 32000)
        self.assertLessEqual(r.wait(6, 0), 50000)
        self.assertLessEqual(r.wait(7, 0), 50000)
        self.assertLessEqual(r.wait(50, 0), 50000)
